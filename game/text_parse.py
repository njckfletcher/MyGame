...
def parse_command(prompt,
    ...
    # Remove filler words from raw_parts and add them to fixed_parts and set count
    ...
    for i in range(num_actv_actions):
        ...
        # Get current location (per action)
        ...
        if has_article[0] and has_sec_adj[0]:
        ...
        elif (has_article[0] and has_adj[0]) or (has_sec_adj[0]):
            if active_actions[0] in loc_actions:
        ...
        elif has_article[0] or has_adj[0]:
            if active_actions[0] in loc_actions:
        ...
        if active_actions[0] == 'level':
        ...
        elif (active_actions[0] == 'stats' or
              active_actions[0] == 'status' or
              active_actions[0] == 'info'):
            player.display_stats()

        elif (active_actions[0] == 'goto' or
              active_actions[0] == 'move' or
              active_actions[0] == 'go'):
            location_handle(active_actions,
                            has_article,
                            has_adj,
                            has_sec_adj,
                            has_dir_obj,
        ...
        elif (active_actions[0] == 'take' or
              active_actions[0] == 'grab' or
              active_actions[0] == 'pickup' or
              active_actions[0] == 'pick'):
            item_handle(active_actions,
                        has_article,
                        has_adj,
                        has_sec_adj,
                        has_dir_obj,
        ...
        elif (active_actions[0] == 'put' or
              active_actions[0] == 'place'):
            put_handle(active_actions,
                       has_article,
                       has_adj,
                       has_sec_adj,
                       has_dir_obj,
            ...
            if not saved and not just_saved:
...
def location_handle(active_actions, has_article,
                    has_adj,
                    has_sec_adj,
                    has_dir_obj,
                    active_locs,
    ...
    # Handles issue of removing locations from active_locs list
    # when the current action appears after it
    while active_locs != []:
    ...
    # Handles issue of removing adjectives from active_adjs list
    # when the current action appears after it
    while active_adjs != []:
...
def open_handle(active_actions,
                has_article,
                has_adj,
                has_sec_adj,
                has_dir_obj,
...
def item_handle(active_actions,
                has_article,
                has_adj,
                has_sec_adj,
                has_dir_obj,
